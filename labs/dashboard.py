...
def main() -> int:
    ...
    fleet = q(c, f"SELECT tool_name, agent_version, calls, errors, blocked, sessions, "
                 f"ROUND(error_rate,3) error_rate, ROUND(avg_latency_ms) avg_latency_ms "
...
<div class="card">{table(fleet, [
    ...
    ("error_rate","error rate"),("avg_latency_ms","avg ms")],
    {"calls","errors","blocked","sessions","error_rate","avg_latency_ms"})}</div>
